    ...
    <div class="card h-100 rounded-lg">
        <div class="card-body p-4">
            ...
            <div class="mb-4">
                ...
                <small class="text-muted d-block mt-2">Perbandingan Persentase Total sertifikat dan pelatihan yang telah dosen upload berdasarkan Tahun.</small>
            </div>
                {{-- <div class="d-flex"> --}}
    ...
    <div class="card h-50 rounded-lg">
        <div class="card-body p-4">
            <div class="d-flex flex-column">
                ...
                <small class="text-muted d-block mt-2 mb-2">Perbandingan Jumlah Total sertifikat dan pelatihan yang telah dosen upload berdasarkan Tahun.</small>
                <div class="contribution-list">
                    <!-- Current Year -->
