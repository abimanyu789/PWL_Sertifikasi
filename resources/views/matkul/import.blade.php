        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ asset('template_matkul.xlsx') }}" class="btn btn-info btnsm" download><i
                            class="fa fa-file-excel"></i> Download</a>
                    <small id="error-mk_id" class="error-text form-text textdanger"></small>
                </div>
                <div class="form-group">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) { // jika sukses
                            ...
                            tableMatkul.ajax.reload(); // reload datatable
                        } else { // jika error
                            $('.error-text').text('');
